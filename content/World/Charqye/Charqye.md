Charqye, or spelled charqü *(pronounced sharply Char kyeh)*, are the most basic form of existence, the 'potential' for something to exist at all. At first they're simply nothing, again purely being potential, overtime they integrate into their surroundings, mimicking its  information, meaning smell, sounds, behavior, colors, shape, and even thoughts which all dictate how it's perceived, though as they don't start out very accurate it can make them seem to be supernatural, this includes them experimenting in a way when active. While this behavior suggests that they're sentient, they  strictly are not, excluding the [[Patron|patrons]].
...
> The steps mentioned are the charqü decreasing its scope and being able to more accurately mimic different parts and properties within it. Imagine one related to a pond, interacting with sendiment, minerals and plants lessening its scope to simply the liquid, refining itself.
...
These are two states mostly unrelated to the cycle, at most the former accelerating it and the latter halting it. First is blight, when charqü are too agitated or overstimulated, they start blighting. When this happens they temporarily become unstable and extremely volatile, all of their energy being used to scatter the traits and properties in the environment, and as such greatly altering and scarring it. The only one they always keep is 'to be', to exist in the state that they are.

Blighted charqü are not per se dangerous, as the volitivity is specifically the transitional state and its side-effects. The only way for blighted charqü to heal is to absorb healthy ones (if your colors are too dark, you add white). While blighting is usually fatal or greatly diminishing, it's not uncommon for whatever is affected to technically 'function', which when affecting life can make it resemble the undead, these creatures are simply called [[Blighted]]. That absorptive behavior sometimes extends into creatures, creating cannibalistic and more often than not aggressive beasts. Absorbed charqü become part of the blighted one and will return to the cycle, if and when it does.

> Blight generally makes whatever it affects look sick and/or withered, this goes for everything applicable.

Blooming on the other hand is largely simple, it's when charqü harmonize with one another to reduce workload, this guarantees great activity, but also cohesion. This both accelerates the leads growth and creates a location where the world behaves differently, causing anomalies such as impossibly fertile land or the aforementioned one-way entry rule. This is often accompanied by distinct repeating visuals. Blooming does mean other charqü follow suit, which can cause chain reactions that are especially dangerous if the lead blights.

## Ecology

Charqü may inhabit material forms which includes objects, plants, animals and even humans, the latter being more rare. They stay with their vessel until it become unrecognizable long-term. This is an action they might take to obtain a reference for how 'properly' exists. Whatever they inhabit is referred to as a [[Vessel System|vessel]], said vessel is able to use the inhabiting charqü, allowing for manipulation of the charqü and as a result its output, which makes it look like using magic.
...
Only animals, including humans even with charqü being averse, can use the charqü inhabiting them and are called living-vessels, in contrast to the inanimate vessel-tools. Inhabitation functions like a limb and using it must be practiced, some less intelligent vessels such as fish might not engage. Generally animals can only use them at elementary levels with the more intelligent ones, such as crows and naturally humans, being more apt and possibly dangerous. Due to charqü nature of leaving when a vessel is unrecognizable, you might see packs form where they fight for leadership and power.

When overused, charqü will still blight as per usual, with it leaving the vessel if its destroyed during the process. Besides vessels, there's also [[Handlers#Shepherds|shepherds]] who can interact with charqü in various ways using only thought and intent.
